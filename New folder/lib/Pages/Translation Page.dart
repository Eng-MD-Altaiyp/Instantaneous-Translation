...
class _Translation_PageState extends State<Translation_Page> {
  ...
  String selectedFlag = "assets/flags/united-kingdom-uk-svgrepo-com.svg";
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) {
                        setState(() {
                          ...
                          selectedFlag = countryFlags[index];
                        });
                      },
                      items: languages.asMap().entries.map<DropdownMenuItem<String>>((entry) {
                        int index = entry.key;
                          ...
                          child: Container(
                            child: Padding(
                              ...
                              child: TextField(
                                ...
                                onSubmitted: (value)
                                {
                                  _sendChatMessage(value,selectedLanguage);
                                },
                                onChanged: (value) {
                                  setState(() {
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () {
                    setState(() {
                      _isListening = false;
                      _sendChatMessage(Befor_Translate.text,selectedLanguage);
                    });
                  },
                  child: Container(
                    height: 80,
